...
async function OnBeforeProjectStart(runtime)
{
	...
	runtime.addEventListener("pointerdown",   e => OnPointerDown(runtime, e));
	runtime.addEventListener("pointermove",   e => OnPointerMove(e));
	runtime.addEventListener("pointerup",     e => OnPointerUp(e));
	runtime.addEventListener("pointercancel", e => OnPointerCancel(e));
}
...
function OnPointerDown(runtime, e)
{
