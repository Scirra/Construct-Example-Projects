...
export function PushOutAngle(moveInst: IWorldInstance, obstacleInst: IWorldInstance, angle: number, stepDist = 1, maxDist = 500)
{
...
// Returns true if it pushed out successfully, otherwise false.
export function PushOutVector(moveInst: IWorldInstance, obstacleInst: IWorldInstance, vecX: number, vecY: number, stepDist = 1, maxDist = 500)
{
...
// Returns true if it pushed out successfully, otherwise false.
export function PushOutSolidAngle(inst: IWorldInstance, angle: number, stepDist = 1, maxDist = 500)
{
	// Convert the angle to a vector and call the vector method.
	const vecX = Math.cos(angle);
	const vecY = Math.sin(angle);
...
// Returns true if it pushed out successfully, otherwise false.
export function PushOutSolidVector(inst: IWorldInstance, vecX: number, vecY: number, stepDist = 1, maxDist = 500)
{
