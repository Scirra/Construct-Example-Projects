...
// Object interfaces
let plat; // Platform object
let landBlock0; // Land block 32x32x32 object
let landBlock1; // Land block 64x32x32 object
let landBlock2; // Land block 32x64x32 object
let landBlock3; // Land block 32x32x64 object

// Behaviors
let timer;

// Gameplay variables
let gameStarted; // Has the game started?
let gameOver; // Is the game over?
let lastX; // Last platform X position
let bounces; // Number of bounces

// Settings
const GRAVITY = 1200; // Gravity force (affects player's jump)
