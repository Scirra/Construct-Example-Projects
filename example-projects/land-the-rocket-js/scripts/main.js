...
let fuel; // Fuel left
let landings; // Number of landings
let landed; // Is the rocket on the ground?
let inputsEnabled; // Are the inputs enabled?
let landingPadPositionIndex; // Current landing position index (from the list)
...
function unpauseGame() {
    ...
    if (pauseText) {
        ...
        rocket.behaviors.Physics.vectorX = 0;
        rocket.behaviors.Physics.vectorY = 0;
...
function onExplosionAnimationEnd(e) {
...
function moveStarfield(runtime) {
...
function stabilizeRocket() {
    ...
    rocket.behaviors.Physics.vectorX = 0;         // Stop lateral movement
...
function checkCollision(runtime) {
