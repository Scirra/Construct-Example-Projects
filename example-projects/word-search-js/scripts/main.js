...
import * as wordHunt from "./wordHunt.js"
...
// Other variables.
let table;	// Abstract table.
let cmk; 	// Current marker.
...
function finishMarker(e) {
	...
	const letterFound = letter.getAllInstances().some(l => foundLetter(l, endPos));
