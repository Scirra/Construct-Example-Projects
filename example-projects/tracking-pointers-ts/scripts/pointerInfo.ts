...
export class PointerInfo {
	...
	lineMarker: InstanceType.TiledBackground;
	startMarker: InstanceType.StartMarker;
	endMarker: InstanceType.EndMarker;
	textLabel: InstanceType.PointerLabel;

	// PointerInfo is created in the "pointerdown" event.
	constructor(runtime: IRuntime, e: PointerEvent)
	{
...
pointerId ${e.pointerId}`;
	...
	CssPxToLayer(clientX: number, clientY: number)
	{
