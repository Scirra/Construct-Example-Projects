...
function TickBullet(runtime: IRuntime, bulletInst: InstanceType.Bullet)
{
...
function PointPlayerTowardsMouse(runtime: IRuntime)
{
...
function OnPointerDown(runtime: IRuntime)
{
